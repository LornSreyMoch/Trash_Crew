...
import 'package:trash_crew/models/schedule_model.dart' as model;
import 'package:trash_crew/views/Schedule.dart' as view;
    ...
    try {
      ...
      if (user != null) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const view.Schedule()),
        );
      } else {
